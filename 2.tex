...
\vskip 0.2cm
{\centerline {\Large April, 2019}}
\vskip 0.4cm
{\centerline {\Large Final version submitted in \textemdash, 2019}}
\end{center}
\end{titlepage}
...
\begin{declaration}
\begin{figure}
\includegraphics[scale=0.55]{scanned_Declaration}
\thispagestyle{empty}
\end{figure}
\end{declaration}
\cleardoublepage
